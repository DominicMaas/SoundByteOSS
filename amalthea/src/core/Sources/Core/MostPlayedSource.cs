...
{
    public class MostPlayedSource : ISource
    {
        private readonly IAuthenticationService _authenticationService;

        public MostPlayedSource(IAuthenticationService authenticationService)
        {
        ...
        public async Task<SourceResponse> GetItemsAsync(int count, string token, CancellationToken cancellationToken = default)
        {
            ...
            if (await _authenticationService.IsSoundByteAccountConnectedAsync() == false)
                return new SourceResponse("Not signed in", "Sign in to or create a SoundByte Account to keep track of your most played songs across services.");
            ...
            return await Policy
                ...
                .ExecuteAsync(async () =>
                {
                    ...
                    var request = await Constants.SoundByteMediaWebsite
                        .AppendPathSegment("/api/v1/most-played")
                        .SetQueryParams(new
                        {
                        ...
                        .GetSoundByteJsonAsync<MostPlayedOutputModel>(_authenticationService);

                    // The user does not have any most played tracks
                    if (!request.Items.Any())
                    {
                        return new SourceResponse("No Items", "Start listening to some music to build up your most played.");
                    }
        ...
        public class MostPlayedOutputModel
        {
